...
const aboutI18n = {
  en: {
    ...
    'about.experience.title': 'Where I’ve worked',
    'about.experience.ant.date': '2024.07 - Present',
    'about.experience.ant.company': 'Ant Group',
    'about.experience.ant.role': 'Product Designer',
    'about.experience.ant.summary': 'Led research and core interaction design across wealth management, cross-border brokerage, and AI infrastructure—turning complex financial systems into scalable products and reusable design capabilities.',
    'about.experience.alibaba.date': '2023.06 - 2023.09',
    'about.experience.alibaba.company': 'Alibaba',
    'about.experience.alibaba.role': 'UX Design Intern',
    'about.experience.alibaba.summary': 'Turned customer research into a clear freshness proposition for next-day grocery delivery, aligning digital and physical touchpoints into one consistent, credible experience.',
    'about.experience.pratt.date': '2022.10 - 2024.06',
    'about.experience.pratt.company': 'Center for Digital Experiences at Pratt Institute',
    'about.experience.pratt.role': 'UX Consultant',
    'about.experience.pratt.summary': 'Synthesized interviews, card sorting, tree testing, and usability findings into a redesigned information architecture, user flows, and responsive sites for our clients.',
  ...
  zh: {
    ...
    'about.experience.ant.date': '2024.07 - 至今',
    'about.experience.ant.company': '蚂蚁集团',
    'about.experience.ant.role': '产品设计师',
    'about.experience.ant.summary': '负责财富管理、跨境券商与 AI 基础设施方向的研究和核心交互设计，将复杂金融系统转化为可扩展的产品与可复用的设计能力。',
    'about.experience.alibaba.date': '2023.06 - 2023.09',
    'about.experience.alibaba.company': '阿里巴巴',
    'about.experience.alibaba.role': '用户体验设计实习生',
    'about.experience.alibaba.summary': '将用户研究转化为次日达生鲜配送的清晰新鲜度主张，并统一线上与线下触点，打造一致、可信的体验。',
    'about.experience.pratt.date': '2022.10 - 2024.06',
    'about.experience.pratt.company': '普瑞特艺术学院数字体验中心',
    'about.experience.pratt.role': '用户体验顾问',
    'about.experience.pratt.summary': '综合访谈、卡片分类、树测试与可用性研究结果，为客户重新设计信息架构、用户流程和响应式网站。',
    'footer.copy': 'crafted with <span class="footer-love-mark" role="img" aria-label="love"></span> &amp; made with AI by Lynn'
  }
};
